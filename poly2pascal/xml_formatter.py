...
def get_start_str(
        folder, filename, path, width, height, 
        depth=3, segmented=0, database="Unknown"
        ):
    """
...
def get_xml_object_str(
    ...
    pose="Unspecified", truncated=0, difficult=0, occluded=0
    ):
    """
...
def get_image_xml_annotaion(
    ...
    final_xml_content_list = [xml_start_content] + xml_object_strings + [xml_end_content]
